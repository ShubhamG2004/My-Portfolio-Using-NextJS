    ...
    <section id="about" className="bg-gray-50 py-20 px-8">
      <div className="max-w-6xl mx-auto"> {/* Increased from max-w-5xl to max-w-6xl */}
        ...
        <div className="text-xl leading-relaxed text-gray-700 space-y-6 bg-white p-12 rounded-xl shadow-sm border border-gray-100 w-full"> {/* Added w-full and increased padding */}
          <p>I'm a <strong className="text-gray-900">Full-Stack Developer</strong> and Computer Engineering student at PES Modern College, blending academic knowledge with hands-on development expertise across web and mobile platforms.</p>
          ...
          <p>I'm deeply passionate about <strong>emerging technologies</strong> (AI/ML, Blockchain, IoT) and thrive in collaborative, innovative environments that push technological boundaries.</p>
        </div>
      </div>
    </section>
  );
